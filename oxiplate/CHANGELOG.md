...
- updated toolchain to nightly-2026-09-24
- removed Rust version check that isn't needed due to pinning the toolchain

## [0.19.5](https://github.com/0b10011/oxiplate/compare/oxiplate-v0.19.4...oxiplate-v0.19.5) - 2026-09-24

### Added

- added support for lifetime generics ([#343](https://github.com/0b10011/oxiplate/pull/343))

## [0.19.4](https://github.com/0b10011/oxiplate/compare/oxiplate-v0.19.3...oxiplate-v0.19.4) - 2026-09-22

### Added

- added support in expressions for paths and function calls ([#337](https://github.com/0b10011/oxiplate/pull/337))

## [0.19.3](https://github.com/0b10011/oxiplate/compare/oxiplate-v0.19.2...oxiplate-v0.19.3) - 2026-09-20
...
- fixed clippy lint for test attributes in doc tests
...
## [0.17.1](https://github.com/0b10011/oxiplate/compare/oxiplate-v0.17.0...oxiplate-v0.17.1) - 2026-08-21
